...
//Colors for dispatchAlert
export const sigappu: string = "#c0392b";
export const neelam: string = "#2980b9";
export const pachai: string = "#27ae60";
export const aaranji: string = "#f39c12";
...
export const dispatchAlert = (
  ...
  dispatchTS("showAlert", { message, color, timeout });
};
